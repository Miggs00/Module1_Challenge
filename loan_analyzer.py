...
print('The total number of loans on the list is:', number_of_loans)

# What is the total of all loans?
# @TODO: Use the `sum` function to calculate the total of all loans in the list.
# Print the total value of the loans
total_of_loans = sum(loan_costs)
print('The total of loans on this list is:', total_of_loans)
...
print(f'The future value is {future_value}, and the remaining months are {remaining_months}')
...
def fair_value(future_value, remaining_months):
...
if fair_value(future_value, remaining_months) >= cost:
...
present_value = present_value(future_value=1000, remaining_months=12, annual_discount_rate=.2)
